...
public class CiDetailedReport {
    ...
    private double minrange;//检查项明细正常值范围的最小值
    private double maxrange;//检查项明细正常值范围的最大值
    private String normalValue;//检查项明细正常值（非数字）
    private String normalValueString;//检查项范围说明文字
    private Integer type;//检查项明细类型（1：数值范围验证型 2：数值相等验证型 3：）
    private String value;//检查项明细值
